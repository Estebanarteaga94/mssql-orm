...
| `AuditProvider` | Partial | Public runtime contract and audit-owned entity metadata exist. Context transport and insert/update auto-fill remain deferred. |
...
- `AuditProvider` context transport and insert/update auto-fill.
