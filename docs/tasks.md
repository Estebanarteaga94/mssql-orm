...
- [ ] Etapa 15: Consolidar ejemplos ejecutables y guías de uso (`todo_app`, variables de entorno y smoke local, y resolver la inconsistencia documental de `basic-crud`)
