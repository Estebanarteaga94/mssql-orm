...
1. Ejecutar `Etapa 16+: Hacer que DbSet::delete(...), delete_by_sql_value(...), delete_tracked_by_sql_value(...), entity.delete(&db) y save_tracked_deleted() usen UpdateQuery cuando la entidad tenga soft_delete`.
