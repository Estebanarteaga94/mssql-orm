...
1. Ejecutar `Etapa 15: Preparar guía de relaciones y joins explícitos con foreign keys derivadas`.
2. Continuar luego con la consolidación de API docs mínimas y surface pública publicada por la crate raíz.
