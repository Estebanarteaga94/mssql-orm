...
1. Ejecutar `Etapa 16: Agregar pruebas de diff donde activar audit = Audit sobre una tabla existente genere AddColumn para cada columna auditable esperada`.
2. Continuar luego con la prueba de remoción destructiva y validación DDL de columnas auditables antes de actualizar el ejemplo `todo-app`.
