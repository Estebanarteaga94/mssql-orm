...
1. Ejecutar `Etapa 16: Actualizar el ejemplo todo-app o agregar fixture dedicado para mostrar al menos una entidad con #[orm(audit = Audit)] sin degradar el smoke existente`.
2. Continuar después con el exportador de snapshot del ejemplo actualizado para validar que `migration add --snapshot-bin ...` capture columnas auditables.
