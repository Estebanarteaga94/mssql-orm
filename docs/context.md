...
1. Ejecutar `Etapa 16: Confirmar que ModelSnapshot::from_entities(...) incluye columnas auditables sin cambios especiales en snapshot, serialización JSON ni orden determinista`.
2. Continuar luego con las pruebas de migraciones/DDL de Etapa 16 para entidades auditadas antes de actualizar el ejemplo `todo-app`.
