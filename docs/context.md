...
1. Ejecutar `Etapa 15: Preparar guía de transacciones y límites operativos de db.transaction(...)`.
2. Continuar luego con la guía de relaciones y joins explícitos con foreign keys derivadas.
