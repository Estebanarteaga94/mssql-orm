...
1. Ejecutar `Etapa 15: Consolidar API docs mínimas y surface pública publicada por la crate raíz`.
2. Continuar luego con el changelog inicial del release con surface disponible y exclusiones explícitas.
