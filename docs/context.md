...
1. Ejecutar `Etapa 15: Preparar changelog inicial del release con surface disponible y exclusiones explícitas`.
2. Continuar luego con la validación final de release sobre workspace y ejemplos documentados.
