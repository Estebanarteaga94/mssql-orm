...
1. Ejecutar `Etapa 16: Agregar binario/exportador de snapshot del ejemplo actualizado y validar que migration add --snapshot-bin ... capture columnas auditables en model_snapshot.json`.
2. Continuar después con la tarea que mantiene explícitamente fuera del MVP el autollenado runtime de auditoría en CRUD, Active Record y tracking.
