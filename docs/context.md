...
1. Ejecutar `Etapa 16: Agregar pruebas de migraciones donde una entidad nueva con audit = Audit genere CREATE TABLE con columnas auditables`.
2. Continuar luego con las pruebas de diff y DDL de Etapa 16 para activación/remoción de auditoría antes de actualizar el ejemplo `todo-app`.
