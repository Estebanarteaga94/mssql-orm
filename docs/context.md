...
1. Ejecutar `Etapa 16+: Cubrir soft_delete con pruebas de SQL compilado, CRUD público, Active Record, change tracking y migraciones para evitar que alguna ruta siga haciendo borrado físico por accidente`.
