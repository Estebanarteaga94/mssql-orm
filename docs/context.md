...
1. Ejecutar `Etapa 16: Agregar pruebas de diff donde quitar audit = Audit sea detectado como destructivo por la CLI cuando produzca DropColumn`.
2. Continuar luego con la validación DDL de columnas auditables antes de actualizar el ejemplo `todo-app`.
