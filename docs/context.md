...
1. Ejecutar `Etapa 16: Validar el SQL Server DDL generado para columnas auditables con defaults como SYSUTCDATETIME(), longitudes nvarchar, nullability y tipos fecha compatibles`.
2. Continuar luego con el fixture/ejemplo `todo-app` y exportador de snapshot auditado.
