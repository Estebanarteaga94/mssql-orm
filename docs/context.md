...
1. Ejecutar `Etapa 16+: Implementar visibilidad de lectura para soft_delete en DbSetQuery con modo por defecto ActiveOnly y APIs públicas with_deleted() / only_deleted()`.
